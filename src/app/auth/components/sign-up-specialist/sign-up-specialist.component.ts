...
import { SignUpRequest, SignUpSpecialistRequest } from 'src/app/common/models/request';

@Component({
	selector: 'app-signup-specialist',
	templateUrl: './sign-up-specialist.component.html',
	styleUrls: ['./sign-up-specialist.component.scss']
})
export class SignUpSpecialistComponent implements OnInit {
    ...
    public submit(form: FormGroup) {
        ...
        const request: SignUpSpecialistRequest = form.value;
        request.phoneNumber = phone;

        this.authService.signUpSpecialist(request)
            .subscribe(data => {
                this.isLoading = false;
